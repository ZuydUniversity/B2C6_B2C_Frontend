        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <div>
                ...
                <input id="firstnameContact" type="text" value={firstnameContact} onChange={(e) => setFirstnameContact(e.target.value)} 
                />
            </div>
            <div>
                <label htmlFor="lastnameContact">Achternaam Contactpersoon:</label>
                <input id="lastnameContact" type="text" value={lastnameContact} onChange={(e) => setLastnameContact(e.target.value)} 
                />
            </div>
            <div>
            ...
            <div>
                <label htmlFor="phonenumberContact">Telefoonnummer Contactpersoon:</label>
                <input id="phonenumberContact" type="tel" value={phonenumberContact} onChange={(e) => setPhonenumberContact(e.target.value)} 
                />
            </div>
            <div>
                <label htmlFor="specialist">Specialist:</label>
                <input id="specialist" type="text" value={specialist} onChange={(e) => setSpecialist(e.target.value)} 
                />
            </div>
            <div>
            ...
            <div>
                ...
                <input id="appointment" type="text" value={appointment} onChange={(e) => setAppointment(e.target.value)} 
                />
            </div>
            <br />
            <br />  

...
const patients = [
	...
	new Patient("Jane", "Smith", "jane.smith@example.com", 28, "111-222-3333", false, "John", "Smith", "john.smith@example.com", "444-555-6666"),
	new Patient("Alice", "Johnson", "alice.johnson@example.com", 45, "777-888-9999", true, "Bob", "Johnson", "bob.johnson@example.com", "000-111-2222"),

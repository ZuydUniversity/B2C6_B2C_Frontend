			...
			<main>
				...
				<div className="settings-layout-styling">
					...
					<nav className="settings-navbar">
						<ul>
							<li id="Profiel" className={selectedItem === "Profiel" ? "active" : ""} onClick={() => handleNavClick("Profiel")}>
								Profiel
							</li>
							<li id="Meldingen" className={selectedItem === "Meldingen" ? "active" : ""} onClick={() => handleNavClick("Meldingen")}>
								Meldingen
							</li>
							<li id="Logboek" className={selectedItem === "Logboek" ? "active" : ""} onClick={() => handleNavClick("Logboek")}>
								Logboek
							</li>
							<li id="Dashboard" className={selectedItem === "Dashboard Instellingen" ? "active" : ""} onClick={() => handleNavClick("Dashboard Instellingen")}>

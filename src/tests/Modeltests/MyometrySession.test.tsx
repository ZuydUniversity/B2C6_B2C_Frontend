import { Specialist, Patient, Appointment, Note, MyometrySession } from "../../abstracts/ImportsModels";

describe("MyometrySession", () => {
	...
	it("should create a new myometrySession with all the provided properties", () => {
		const session = new MyometrySession(name, startdatetime, enddatetime, specialist, patient, appointment);
	...
	it("should create a new myometrySession with the provided notes", () => {
		const session = new MyometrySession(name, startdatetime, enddatetime, specialist, patient, appointment);
	...
	it("should update the myometrySession's specialist", () => {
		const session = new MyometrySession(name, startdatetime, enddatetime, specialist, patient, appointment);
	...
	it("should update the myometrySession's patient", () => {
		const session = new MyometrySession(name, startdatetime, enddatetime, specialist, patient, appointment);
	...
	it("should update the myometrySession's appointment", () => {
		const session = new MyometrySession(name, startdatetime, enddatetime, specialist, patient, appointment);
	...
	it("should update the myometrySession's timestamps", () => {
		const session = new MyometrySession(name, startdatetime, enddatetime, specialist, patient, appointment);

...
describe("Patient", () => {
	...
	it("should create a new patient with the provided specialists, notes, medications and appointments", () => {
		...
		const specialists: Array<Specialist> = [new Specialist("John", "Doe", "JohnDoe@gmail.com", "0612345678")];
		const appointments: Array<Appointment> = [new Appointment("cheeseAppointment", new Date(), new Date(), specialists[0], patient)];
		const notes: Array<Note> = [new Note("note1", "description1", specialists[0], patient), new Note("note2", "description2", specialists[0], patient)];
		const medications: Array<Medication> = [new Medication("medication1", "description1", patient), new Medication("medication2", "description2", patient)];

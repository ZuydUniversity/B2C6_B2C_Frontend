import { Session, Specialist, Patient, Appointment, Note } from "../../abstracts/ImportsModels";
...
describe("Session", () => {
	...
	it("should create a new session with all the provided properties", () => {
		const session = new Session(name, startdatetime, enddatetime, specialist, patient, appointment);

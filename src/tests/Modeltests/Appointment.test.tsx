...
describe("Appointment", () => {
	...
	it("should create a new appointment with the provided sessions", () => {
		const appointment = new Appointment(name, startdatetime, enddatetime, specialist, patient);
		const sessions: Array<Session> = [new Session("session1", new Date(), new Date(), specialist, patient, appointment), new Session("session2", new Date(), new Date(), specialist, patient, appointment)];
